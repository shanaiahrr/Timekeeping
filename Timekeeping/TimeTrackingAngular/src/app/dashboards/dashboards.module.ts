...
@NgModule({
  ...
  providers: [],
  entryComponents: [ImportMasterFileComponent, SaveDialogComponent, ViewEmployeeInfoComponent, UpdateSaveDialogComponent, AddNewShiftComponent, DeleteDialogComponent],
  declarations: [AdminComponent, ImportMasterFileComponent, Dashboard2Component, ManageRolesComponent, 
                 RoleComponent, NewEmployeeComponent, AssignRolesComponent, SaveDialogComponent, 
                 TimekeepingComponent, ApplyLeaveComponent, ManageLeavesComponent, 
                 AddNewLeavesComponent, ViewEmployeeInfoComponent, UpdateSaveDialogComponent, ManageWorkShiftsComponent, AddNewShiftComponent, EditLeavesComponent, DeleteDialogComponent]
})
