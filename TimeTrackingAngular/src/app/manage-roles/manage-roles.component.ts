...
export class ManageRolesComponent implements OnInit {
  ...
  displayedColumns: string[] = ['roleName', 'actions'];Router
  indexOfRole: number = 0;
  isDeleteRole: boolean;

  constructor(private roleService: RoleService, private dialog:MatDialog, private router:Router) { }
...
// editRole(){
//     this.router.navigate(['role/edit-role']);
//       }
}